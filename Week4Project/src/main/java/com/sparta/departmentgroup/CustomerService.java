...
public class CustomerService extends Employee implements Department {
    ...
    public CustomerService(int emp_no, String birth_date, String first_name, String last_name, String gender, String hire_date) {
        super(emp_no, birth_date, first_name, last_name, gender, hire_date, "Customer Service");
    }
